...
//
//  Created by Chico Pereira on 03/04/2022.
//
...
class FeedSnapshotTests: XCTestCase {
    ...
    private func feedWithContent() -> [ImageStub] {
        return [
            ImageStub(description: "The East Side Gallery is an open-air gallery in Berlin. It consists of a series of murals painted directly on 1,316m long remnant of the Berlin Wall, located near the centre of Berlin, on Muhlenstrabe in Friedrichshain-Kreuzberg. The gallery has official status as Denkmal, or heritage-protected landmark.", location: "East Side Gallery\nMemorial in Berlin, Germany", image: UIImage.make(withColor: .red)),
...
struct SnapshotConfiguration {
    ...
    static func iPhone8(style: UIUserInterfaceStyle) -> SnapshotConfiguration {
        return SnapshotConfiguration(size: CGSize(width: 375, height: 667), safeAreaInsets: UIEdgeInsets(top: 20, left: 0, bottom: 0, right: 0), layoutMargins: UIEdgeInsets(top: 20, left: 16, bottom: 0, right: 16), traitCollection: UITraitCollection(traitsFrom: [
